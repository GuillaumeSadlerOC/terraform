...
resource "aws_cloudfront_distribution" "this" {
  ...
  dynamic "default_cache_behavior" {
    ...
    content {
      ...
      forwarded_values {
        ...
        cookies {
          forward           = lookup(i.value, "cookie_forward", "none")
  ...
  dynamic "custom_error_response" {
    ...
    content {
      ...
      response_page_path    = lookup(custom_error_response.value, "response_page_code", null)
      error_caching_min_ttl = lookup(custom_error_response.value, "error_caching_min_ttl", null)
    }
  }

  # Restricts who os able to access this content
  restrictions {
